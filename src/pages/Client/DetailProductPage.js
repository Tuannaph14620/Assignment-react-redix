...
import { listProductsOne } from '../../features/productSlice'
  ...
  <section>
    <div> 
      <div className="flex justify-between px-20 pt-10">
        <div className="pro1">
          <img src={`${product.img}`} width="500px" height="500px" alt />
        </div>
        <div className="mt-4 lg:mt-0 lg:row-span-4">
          <h2 className="sr-only">Product information</h2>
          <p className="text-3xl text-gray-900">{Number(product.price).toLocaleString('it-IT', { style: 'currency', currency: 'VND' }) }</p>
          <div className="mt-6">
